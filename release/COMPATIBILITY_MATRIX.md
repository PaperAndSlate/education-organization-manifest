...
| --------------------------------------- | ----------------------------- | --------------------------------------------------------- | ------------------------------ |
| EOM 1.0 specification                   | `v1.0.0-rc.3`                 | immutable copy and checksum in `manifest.json`            | working draft                  |
| EOM 1.0 schemas                         | `v1.0.0-rc.3`                 | 47 JSON Schema 2020-12 files plus catalog and schema gate | working draft                  |
| Versioned vocabularies                  | `v1.0.0-rc.3`                 | registry, 19 categories, snapshots, digests               | working draft                  |
| TypeScript packages                     | `1.0.0-rc.3`                  | lockfile, typecheck, build, clean tarball install         | local reference implementation |
