...
The `v1.0.0-rc.1/` directory and its archive are preserved as immutable historical evidence and are
superseded by the current `v1.0.0-rc.2/` candidate. RC2 includes the specification, schemas,
